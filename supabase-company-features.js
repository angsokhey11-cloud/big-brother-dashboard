/* BIG BROTHER — Supabase Company Features Dashboard Integration V1.2 */
(function(){
'use strict';
const EXTRA={
  ...
  /* Damaged Stock uses Stock In-Out for key-in. These routes are reporting / clearance only. */
  'stock-damaged':{module:'Stock Management',url:'https://angsokhey11-cloud.github.io/big-brother-stock-report/damage-stock-report.html?embed=1&v=20260910-3',button:'navStockDamagedReport'},
  'stock-damaged-report':{module:'Stock Management',url:'https://angsokhey11-cloud.github.io/big-brother-stock-report/damage-stock-report.html?embed=1&v=20260910-3',button:'navStockDamagedReport'},
  'stock-damaged-cleared':{module:'Stock Management',url:'https://angsokhey11-cloud.github.io/big-brother-stock-report/damaged-stock-cleared.html?embed=1&v=20260910-3',button:'navStockDamagedCleared'}
};
...
function installDamagedStockMenuFix(){
  /* Do not duplicate the Stock In-Out key-in screen inside Damaged Stock. */

...
const CACHE='bb-mobile-shell-v28';
...
function injectRouter(html){
  let out=html;
  if(!out.includes('data-bb-router-v4')){const tag='<script data-bb-router-v4 src="mobile-main-menu-v3.js?v=20260920-history2"></script>';out=out.includes('</body>')?out.replace('</body>',tag+'\n</body>'):out+tag}

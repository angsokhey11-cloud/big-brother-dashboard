...
const CACHE='bb-mobile-shell-v10';
...
function injectRouter(html){
  ...
  if(!out.includes('data-bb-theme-v1')){const tag='<script data-bb-theme-v1 src="mobile-theme-v1.js?v=20260920-moderntech1"></script>';out=out.includes('</body>')?out.replace('</body>',tag+'\n</body>'):out+tag}
  return out;
}

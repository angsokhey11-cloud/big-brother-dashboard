...
const CACHE='bb-mobile-shell-v31';
...
function injectRouter(html){
  ...
  if(!out.includes('data-bb-navigation-v5')){const tag='<script data-bb-navigation-v5 src="mobile-navigation-v5.js?v=20260920-history5"></script>';out=out.includes('</body>')?out.replace('</body>',tag+'\n</body>'):out+tag}
